...
public class ProcessPelArray {
    ...
    private static final int FINAL_WIDTH  = 480;
    private static final int FINAL_HEIGHT = 480;
    private static final int SCALED_WIDTH = 256;
    private static final int SCALED_HEIGHT = 256;
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int y = 0; y < img.getHeight(); y++) {
            for (int x = 0; x < img.getWidth(); x++) {
                ...
                //if (gray < 125) gray = 0;        // optional force hand white
                //if (gray > 125) gray = 255;     // force background black
